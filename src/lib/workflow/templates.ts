...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    emoji: '📸',
    nodes: [
      { id: 'p-1', type: 'referenceImage', position: { x: 60,  y: 160 }, data: { label: 'Entrada de Imagem', image: null } },
      { id: 'p-2', type: 'prompt',         position: { x: 380, y: 160 }, data: { label: 'Prompt', prompt: 'Professional product photo, studio lighting, white background, 4K quality' } },
      { id: 'p-3', type: 'imageOutput',    position: { x: 700, y: 160 }, data: { label: 'Saída de Imagem', modelId: 'nano-banana-legacy', aspectRatio: '1:1' } },
    ],
    edges: [
  ...
  },
  {
    ...
    emoji: '🎬',
    nodes: [
      { id: 'v-1', type: 'referenceImage', position: { x: 60,  y: 160 }, data: { label: 'Entrada de Imagem', image: null } },
      { id: 'v-2', type: 'prompt',         position: { x: 380, y: 160 }, data: { label: 'Prompt', prompt: 'Smooth cinematic motion, professional lighting, elegant product showcase' } },
      { id: 'v-3', type: 'videoOutput',    position: { x: 700, y: 160 }, data: { label: 'Saída de Vídeo', modelId: 'veo-3.1-lite', aspectRatio: '16:9', resolution: '720p' } },
    ],
    edges: [
  ...
  },
  {
    ...
    emoji: '✨',
    nodes: [
      { id: 'a-1', type: 'referenceImage', position: { x: 60,  y: 260 }, data: { label: 'Entrada de Imagem', image: null } },
      { id: 'a-2', type: 'prompt',         position: { x: 380, y: 260 }, data: { label: 'Prompt', prompt: 'Professional product showcase, clean background, studio lighting' } },
      { id: 'a-3', type: 'imageOutput',    position: { x: 700, y: 60  }, data: { label: 'Saída de Imagem', modelId: 'nano-banana-legacy', aspectRatio: '1:1' } },
      { id: 'a-4', type: 'videoOutput',    position: { x: 700, y: 380 }, data: { label: 'Saída de Vídeo', modelId: 'veo-3.1-lite', aspectRatio: '16:9', resolution: '720p' } },
    ],
    edges: [
