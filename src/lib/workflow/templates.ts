...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    nodes: [
      ...
      { id: 'p-3', type: 'imageOutput',    position: { x: 700, y: 160 }, data: { label: 'Saída de Imagem', modelId: 'flux-schnell', aspectRatio: '1:1' } },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'a-3', type: 'imageOutput',    position: { x: 700, y: 60  }, data: { label: 'Saída de Imagem', modelId: 'flux-schnell', aspectRatio: '1:1' } },
